...
/**
 * @brief Similar to libc memdup.
 */

__NYX_NULLABLE__ buff_t nyx_buffer_ndup(
    __NYX_NULLABLE__ BUFF_t b,
    __NYX_ZEROABLE__ size_t n
);
...
/*--------------------------------------------------------------------------------------------------------------------*/
/** @}
  * @defgroup NYX_NUMBER Nyx Number Message
  * @ingroup NYX
  * Nyx Number Message
  * @{
  */
...
/*--------------------------------------------------------------------------------------------------------------------*/
/** @}
  * @defgroup NYX_TEXT Nyx Text Message
  * @ingroup NYX
  * Nyx Text Message
  * @{
  */
...
/*--------------------------------------------------------------------------------------------------------------------*/
/** @}
  * @defgroup NYX_LIGHT Nyx Light Message
  * @ingroup NYX
  * Nyx Light Message
  * @{
  */
...
/*--------------------------------------------------------------------------------------------------------------------*/
/** @}
  * @defgroup NYX_SWITCH Nyx Switch Message
  * @ingroup NYX
  * Nyx Switch Message
  * @{
  */
...
/*--------------------------------------------------------------------------------------------------------------------*/
/** @}
  * @defgroup NYX_BLOB Nyx BLOB Message
  * @ingroup NYX
  * Nyx BLOB Message
  * @{
  */
...
/*--------------------------------------------------------------------------------------------------------------------*/
/** @}
  * @defgroup NYX_STREAM Nyx Stream Message
  * @ingroup NYX
  * Nyx Stream Message
  * @{
  */
